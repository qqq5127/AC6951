...
//#define CONFIG_DEBUG_LITE_ENABLE  //轻量级打印开�? 默认关闭
#endif
...
//2、禁止直接修改这里的配置														   //
//3、应用方向的配置如果与以下默认配置不一致， 必须在自己板卡中进行重定�?          //
...
#define ONE_KEY_CTL_DIFF_FUNC                 1    /*通过左右耳实现一个按键控制两个功�?/
#define CONFIG_TWS_SCO_ONLY_MASTER			  0	   /*通话的时候只有主机出声音*/

/* 配对方式选择 */
#define CONFIG_TWS_PAIR_BY_CLICK            0      /* 按键发起配对 */
#define CONFIG_TWS_PAIR_BY_AUTO             1      /* 开机自动配�?*/
#define CONFIG_TWS_PAIR_BY_FAST_CONN        2      /* 开机快速连�?连接速度比自动配对快,不支持取消配对操�?*/
#define CONFIG_TWS_PAIR_MODE                CONFIG_TWS_PAIR_BY_CLICK

#define CONFIG_TWS_USE_COMMMON_ADDR         1      /* tws 使用公共地址 */
#define CONFIG_TWS_PAIR_ALL_WAY             0      /* tws 任何时�?链接搜索  */

#define CONFIG_TWS_PAIR_BY_BOTH_SIDES       0      /* tws 要两边同时按下才能进行配�?*/
#define CONFIG_TWS_DISCONN_NO_RECONN        0      /* 按键断开tws 不会回连 调用  tws_api_detach(TWS_DETACH_BY_REMOVE_NO_RECONN);*/


/* 声道确定方式选择 */
#define CONFIG_TWS_MASTER_AS_LEFT             0 //主机作为左�?
#define CONFIG_TWS_AS_LEFT_CHANNEL            1 //固定左�?
#define CONFIG_TWS_AS_RIGHT_CHANNEL           2 //固定右�?
#define CONFIG_TWS_LEFT_START_PAIR            3 //双击发起配对的耳机做左�?
#define CONFIG_TWS_RIGHT_START_PAIR           4 //双击发起配对的耳机做右�?
#define CONFIG_TWS_EXTERN_UP_AS_LEFT          5 //外部有上拉电阻作为左�?
#define CONFIG_TWS_EXTERN_DOWN_AS_LEFT        6 //外部有下拉电阻作为左�?
#define CONFIG_TWS_SECECT_BY_CHARGESTORE      7 //充电仓决定左右�?
#define CONFIG_TWS_CHANNEL_SELECT             CONFIG_TWS_LEFT_START_PAIR //配对方式选择

#define CONFIG_TWS_CHANNEL_CHECK_IO           IO_PORTA_07					//上下拉电阻检测引�?
...
#undef CONFIG_TWS_CHANNEL_SELECT
#define CONFIG_TWS_CHANNEL_SELECT             CONFIG_TWS_SECECT_BY_CHARGESTORE	//充电仓区分左�?
#endif //TCFG_CHARGESTORE_ENABLE


#if TCFG_TEST_BOX_ENABLE && (!TCFG_CHARGESTORE_ENABLE)
#define CONFIG_TWS_SECECT_CHARGESTORE_PRIO    1 //测试盒配置左右耳优�?
#else
...
#define CONFIG_DISPLAY_TWS_BAT_LOWER          1 //对耳手机端电量显示，显示低电量耳机的电�?
#define CONFIG_DISPLAY_TWS_BAT_HIGHER         2 //对耳手机端电量显示，显示高电量耳机的电�?
...
#define CONFIG_DISPLAY_DETAIL_BAT             0 //BLE广播显示具体的电�?
#define CONFIG_NO_DISPLAY_BUTTON_ICON         1 //BLE广播不显示按键界�?智能充电仓置1
...
#undef  TCFG_LOWPOWER_LOWPOWER_SEL
#define TCFG_LOWPOWER_LOWPOWER_SEL			0                     //开红外不进入低功�?

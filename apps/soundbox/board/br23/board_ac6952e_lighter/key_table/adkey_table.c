...
const u16 bt_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [3] = {
        KEY_FM_EMITTER_PERV_FREQ,		KEY_FM_EMITTER_PERV_FREQ,			KEY_FM_EMITTER_PERV_FREQ,			KEY_NULL,		KEY_NULL,			KEY_NULL
    },
    [4] = {
        KEY_MUSIC_PREV,	KEY_VOL_DOWN,		KEY_VOL_DOWN,		KEY_NULL,		KEY_NULL,			KEY_NULL
    },
    [5] = {
        KEY_FM_EMITTER_NEXT_FREQ,	KEY_FM_EMITTER_NEXT_FREQ,			KEY_FM_EMITTER_NEXT_FREQ,			KEY_NULL,		KEY_NULL,	KEY_NULL
    },
    [6] = {
...
const u16 music_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    //单击             //长按          //hold         //抬起            //双击                //三击
    [0] = {
        KEY_CHANGE_MODE, KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,		KEY_MUSIC_CHANGE_REPEAT,			KEY_NULL
    },
    [1] = {
    ...
    [7] = {
        KEY_MUSIC_PLAYE_PREV_FOLDER,	KEY_MUSIC_FR,				KEY_MUSIC_FR,	KEY_NULL,		KEY_NULL,		KEY_NULL
    },
    [8] = {

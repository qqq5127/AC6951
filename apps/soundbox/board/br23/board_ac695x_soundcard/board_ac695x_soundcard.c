...
const struct slidekey_port slidekey_list[] = {
    ...
    },
    {
        ...
        .msg = KEY_SOUNDCARD_SLIDE_WET_GAIN,
    },
    {
        .io = IO_PORTC_05,
        .io_up_en = 0,
        ...
        .msg = KEY_SOUNDCARD_SLIDE_HIGH_SOUND,
    },
    {
        .io = IO_PORTC_04,
        .io_up_en = 0,
        ...
        .msg = KEY_SOUNDCARD_SLIDE_LOW_SOUND,
    },
    {
        .io = IO_PORTA_12,
        .io_up_en = 0,
        ...
        .msg = KEY_SOUNDCARD_SLIDE_RECORD_VOL,
    },
    {
        .io = IO_PORTA_10,
        .io_up_en = 0,
        ...
        .msg = KEY_SOUNDCARD_SLIDE_MUSIC_VOL,
    },
    {
        .io = IO_PORTB_03,
        .io_up_en = 0,
        ...
        .msg = KEY_SOUNDCARD_SLIDE_EARPHONE_VOL,
    },
};
...
u16 get_ch_digvol_start(char *logo)
{
	u16 music_vol = soundcard_get_music_vol();
	if(music_vol > 100){
		music_vol = 0;//旋钮音量还没有更新之前， 已经启动了， 默认先设置为0
	}

	if (!strcmp(logo, "music_a2dp")) {
        return music_vol;
    } else if (!strcmp(logo, "music_linein")) {
        return music_vol;
    } else if (!strcmp(logo, "music_pc")) {
        return music_vol;
    } else if (!strcmp(logo, "tone_tone")) {
        return 20;//100;;
    } else if (!strcmp(logo, "mic_mic")) {
		return soundcard_get_mic_vol();
	}
    return 100;
}
